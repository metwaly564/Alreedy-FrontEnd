...
export default function AdminEditDeliveryBoys() {
  ...
  const handleDelete = async (id) => {
    try {
      const response = await fetch(`https://reedyph.com/api/v1/users/deliveryBoy/${id}`, {
        method: 'DELETE',
        headers: {
          'Access-Token': TestToken
        }
  ...
  const handleSubmitAdd = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://reedyph.com/api/v1/users/delivery-boy', {
        method: 'POST',
        headers: {
      ...
      // Refresh the list
      const fetchResponse = await fetch('https://reedyph.com/api/v1/users/all-deliveryBoys', {
        headers: {
          'Access-Token': TestToken
        }
      });
