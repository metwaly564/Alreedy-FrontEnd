...
const Account = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        const response = await axios.get('https://reedyph.com/api/v1/users/user', {
          headers: {
            'Access-Token': token
          }
        });
  ...
  const handleUpdateUser = async (e) => {
    ...
    try {
      ...
      if (Object.keys(updateData).length > 0) {
        await axios.patch(
          'https://reedyph.com/api/v1/users/user',
          updateData,
          {
            headers: {
              'Access-Token': token
  ...
  const handleSendOtp = async () => {
    try {
      ...
      await axios.post(
        'https://reedyph.com/api/v1/users/updatePhone',
  ...
  const handleVerifyPhone = async (e) => {
    ...
    try {
      ...
      await axios.post(
        'https://reedyph.com/api/v1/users/VerefyPhone',
        phoneForm,
        {
          headers: {
            'Access-Token': token
