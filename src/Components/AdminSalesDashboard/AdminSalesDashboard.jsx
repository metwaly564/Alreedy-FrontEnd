...
const AdminSalesDashboard = () => {
  ...
  // API endpoints
  const endpoints = {
    city: 'https://reedyph.com/api/v1/places/city',
    zone: 'https://reedyph.com/api/v1/places/zone',
    product: 'https://reedyph.com/api/v1/products/product',
    orderSubmit: 'https://reedyph.com/api/v1/orders/sales-order'
  };
  ...
  return (
    <>
    <div className="min-h-screen bg-gray-50 p-4 font-alexandria font-light mt-16">
