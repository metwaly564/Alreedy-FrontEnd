    ...
    const fetchCategoriesAndTags = async () => {
      try {
        const [categoriesRes, tagsRes] = await Promise.all([
          axios.get('https://reedyph.com/api/v1/categories'),
          axios.get('https://reedyph.com/api/v1/tags')
        ]);
            ...
            {!isLoading && (
             <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7 gap-x-1 gap-y-3 sm:gap-x-1 sm:gap-y-3">
                {filteredProducts?.length > 0 ? (
                  ...
                  <div className={`${isArabic ? 'ml-[88em]' : 'mr-[88em]'} col-span-2 sm:col-span-3 md:col-span-4 lg:col-span-6 flex flex-col justify-center text-center items-center h-[60vh] w-full mx-auto text-center`} style={{ fontFamily: "'Alexandria', sans-serif" }}>
