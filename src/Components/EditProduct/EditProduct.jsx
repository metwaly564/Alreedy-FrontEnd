...
export default function EditProduct() {
  ...
  useEffect(() => {
    const fetchProductData = async () => {
      try {
        const response = await fetch(`https://reedyph.com/api/v1/products/product/${TempSkuID}`, {
          headers: {
            'Access-Token': TestToken,
          },
        });
  ...
  const handleImageUpload = async () => {
    ...
    try {
      const response = await fetch('https://reedyph.com/api/v1/products/image', {
        method: 'POST',
        headers: {
          'Access-Token': TestToken,
        },
      ...
      const assignResponse = await fetch('https://reedyph.com/api/v1/products/product-image', {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
          'Access-Token': TestToken,
      ...
      const fetchResponse = await fetch(`https://reedyph.com/api/v1/products/product/${TempSkuID}`, {
        headers: {
          'Access-Token': TestToken,
        },
      });
  ...
  const handleUpdateRank = async (imageId) => {
    ...
    try {
      const response = await fetch('https://reedyph.com/api/v1/products/product-image', {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
          'Access-Token': TestToken,
  ...
  return (
    <>
      <ToastContainer
        ...
        theme="dark"
      />
      <div className="p-6 max-w-6xl mx-auto bg-white rounded-lg shadow-md mt-[10vh]">
