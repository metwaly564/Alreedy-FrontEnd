...
export default function AdminEditCities() {
    ...
    const fetchData = async () => {
      try {
        const [citiesRes, zonesRes] = await Promise.all([
          fetch('https://reedyph.com/api/v1/places/city'),
          fetch('https://reedyph.com/api/v1/places/zone')
        ]);
  ...
  const createCity = async () => {
    ...
    try {
      const response = await fetch('https://reedyph.com/api/v1/places/city', {
        method: 'POST',
        headers: {
  ...
  const createZone = async () => {
    ...
    try {
      const response = await fetch('https://reedyph.com/api/v1/places/zone', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Access-Token': TestToken
