...
export default function AdminNavbar() {
  ...
  return (
<>
  <div className="bg-gradient-to-r from-purple-500 to-indigo-600 text-white shadow-md py-2 px-6 flex flex-wrap items-center justify-between fixed top-0 left-0 right-0 z-50">
        {/* Logo */}
        ...
        {/* Navigation Links */}
        <div className="flex items-center space-x-2 md:space-x-6 mt-1 md:mt-0 w-full md:w-auto justify-between">
