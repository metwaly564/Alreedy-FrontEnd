...
import {
  ...
  CubeIcon,
  UserGroupIcon,
  DocumentChartBarIcon // Added this new icon for Reports
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          ...
          <Link 
            ...
            className="bg-white rounded-lg shadow p-6 flex flex-col items-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
          >
            <DocumentChartBarIcon className="h-10 w-10 text-green-600 mb-2" />
            <span className="text-gray-700 font-semibold text-center">Reports</span>
          </Link>
        </div>
      </div>
    </div>
