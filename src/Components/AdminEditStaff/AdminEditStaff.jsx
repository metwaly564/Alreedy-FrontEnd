...
export default function AdminEditStaff() {
  ...
  const fetchStaff = async () => {
    try {
      const response = await fetch('https://reedyph.com/api/v1/users/all-staff', {
        headers: {
  ...
  const fetchStaffById = async (id) => {
    try {
      const response = await fetch(`https://reedyph.com/api/v1/users/staff/${id}`, {
        headers: {
          'Access-Token': getToken()
        }
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isAdding) {
        // Add new staff
        response = await fetch('https://reedyph.com/api/v1/users/staff', {
          method: 'POST',
          headers: {
